    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-200">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="<?php echo $path?>admin/feedbacks" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                ...
                <li>
                    <a href="<?php echo $path?>admin/customers" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
