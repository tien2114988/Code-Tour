<form action="<?php echo $path ?>admin/tours/addTour" method="POST" class="mr-3 container min-w-md" id="thong-tin-tour">
    ...
    <div class="max-w-full">
        ...
        <div class="mb-5 flex w-full items-baseline justify-between my-4">
            ...
            <textarea type="text" name="khong-bao-gom" id="khong-bao-gom" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"> </textarea>
        </div>
        ...
        <div class="mb-5 flex w-full items-baseline justify-between my-4">
            ...
            <textarea type="text" name="dieu-kien-dat-tour" id="dieu-kien-dat-tour" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"> </textarea>
        </div>
        ...
        <div class="mb-5 flex w-full items-baseline justify-between my-4">
            ...
            <textarea type="text" name="mo-ta" id="mo-ta" rows="10" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">  </textarea>
        </div>
        ...
        <div class="mb-5 flex w-full items-baseline justify-between my-4">
            ...
            <textarea type="text" name="dieu-kien-huy-tour" id="dieu-kien-huy-tour" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"> </textarea>
        </div>
