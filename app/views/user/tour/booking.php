          ...
          <div class="row">
              ...
              <div class="mb-3">
                ...
                <div class="d-flex form-row p-2">
                  <div class="col-md-6 p-2 form-group d-flex">
                    ...
                    <input type="number" class="form-control w-25" id="inputName" value="1">
                  </div>
                  <div class="col-md-6 p-2 form-group d-flex">
                    <label class="fw-semibold my-auto me-2" for="inputEmail">Số lượng trẻ em</label>
                    <input type="number" class="form-control w-25 me-2" id="inputEmail" value="0">
                ...
                <div class="d-flex form-row p-2">
                  <div class="col-md-6 p-2 form-group d-flex">
                    ...
                    <input type="text" class="form-control w-50" id="inputName" value="100.000 đ" disabled>
                  </div>
                  <div class="col-md-6 p-2 form-group d-flex justify-content-end">
                    ...
                    <p class="text-danger fw-semibold my-auto fs-5" id="inputEmail">120.000 đ</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-3 m-2 border border-warning rounded-4 p-0">
              ...
              <form action="">
                ...
                <div class="input-group">
                  <textarea name="" class="form-control m-2" cols="10" rows="4" placeholder="Địa chỉ"></textarea>
                </div>
