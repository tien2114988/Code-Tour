<div>
    ...
    <div class="tour__main">
        ...
        <div class="tour__main-container d-flex">
    ...
    <div class="tour__list m-5">
        <h3 class="text-uppercase text-center"> danh sách tour</h3>
        <div class="tour__list-container d-flex">
            <div class="tour__item p-2">
                ...
                <img src="https://tourbonphuong.com/upload/product/305x300x1/z4957220225110-6ceaca3f2879f35207ff6738d62a84c9-2314_305x300.jpg">
            </div>
            <div class="tour__item p-2">
                <div class="tour__item-infor p-2 d-flex flex-column">
                    <h7 class="text-uppercase">miền tây trong ngày</h7>
