                ...
                <div class="user__infor-detail">
                    <form action="#" id="update__form" method="post">
                        <div class="form-floating">
                            <input name="fullname" type="text" id="full-name" class="form-control mb-2  w-100" placeholder="Họ và tên">
                            <label for="full-name">Họ và tên<label>
                        </div>
                        <div class="form-floating">
                            <input name="date" type="date" id="full-name" class="form-control mb-2  w-100">
                            <label for="birthday">Ngày tháng năm sinh</label>
                        </div>
                        <div id="user-info__select-location">

                            <div class="form-floating">
                                <input name="detail" type="text" class="form-control mb-2 w-100" id="address" placeholder="Số nhà, đường,...">
                                <label for="address">Địa chỉ nhận hàng</label>
                            </div>
                        </div>
                        <div class="form-floating">
                            <input name="phone" type="text" id="phone-number" class="form-control mb-2 w-100" placeholder="Số điện thoại">
