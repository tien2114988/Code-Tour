      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mb-2 mb-lg-0 mx-auto">
          <li class="nav-item mx-1">
            <a class="nav-link active" aria-current="page" href="./user/homepage">Trang chủ</a>
          </li>
          <li class="nav-item mx-1">
            <a class="nav-link active" aria-current="page" href="./user/introduce">Giới thiệu</a>
          </li>
          <li class="nav-item dropdown mx-1">
            <a class="nav-link active dropdown-toggle" href="./user/tour" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Tour
            </a>
