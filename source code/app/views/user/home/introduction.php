...
<div class="m-4">
    <div class="container p-4">
        <div class="introduce__container d-flex flex-row w-100">
            <div class="introduce__left flex-1">
                <div class="introduct__left-main">
                    <div class="introduct__left-head">
                    ...
                    <div class="introduct__left-content p-4">
                        ...
                        <div class="mt-2">
                            ...
                            <ul>
                                <li>
                                    <p>- Tour miền tây 1 ngày: MỸ THO - BEN TRE</p>
                                </li>
                                <li>
                                    <p>- Tour miền tây 2 ngày 1 đêm: MỸ THO - BẾN TRE - CẦN THƠ</p>
                                </li>
                                <li>
                                    <p> - Tour miền tây 3 ngày 2 đêm : MỸ THO - BẾN TRE - CẦN THƠ - SÓC TRĂNG - BẠC LIÊU - CÀ MAU</p>
                                </li>
                                <li>
                                    <p>- Tour tham quan vườn trái cây miền Tây, các khu du lịch sinh thái.</p>
                                </li>
                            </ul>
                            <p> Bên cạnh đó, chúng tôi còn có các dịch vụ hỗ trợ đi kèm để có thể đảm bảo mang đến trải nghiệm dịch vụ tốt nhất cho khách
                                hàng như:
                            </p>
                            <ul class="">
                                <li>
                                ...
                                <li>
                                    <p> - Quản lý lữ hành và các gói du lịch tùy chỉnh </p>
                                </li>
                        ...
                        <div>
                            ...
                            <ul>
                                <li>
                                    <p>- Chất lượng là quan tâm hàng đầu.</p>
                                </li>
                                <li>
                                    <p>- Giá tour cạnh tranh nhất.</p>
                                </li>
                                <li>
                                    <p>- Tour thiết kế theo yêu cầu.</p>
                                </li>
                                <li>
                                    <p>- Khởi hành hàng ngày.</p>
                                </li>
                                <li>
                                    <p>- Đặt tour nhanh chóng và thuận tiện.</p>
                                </li>
                                <li>
                                    <p>- Thanh toán linh hoạt.</p>
                                </li>
                                <li>
                                    <p>- Tư vấn và hỗ trợ tối đa cho khách hàng.</p>
                                </li>
                            </ul>
                        </div>
                        ...
                        <p class="text-center mt-2">
                            <img class="w-100" src="https://tourbonphuong.com/upload/images/IMG_7339(1).jpg" alt="photo">
                        </p>
                    </div>
                    <div class="introduct__left-relate d-flex flex-column gap-2">
                        <div class="introduct__left-relate-box">
                            <h6 class="text-uppercase text-2xl fw-bold">tin liên quan</h6>
                        </div>
                        <div class="">
            ...
            <div class="introduce__right flex-1">
                <div class="group-sidebox border py-2 px-2 d-flex flex-column gap-1 ">
                    <div class="sidebox-title border-bottom-1">
                        <h4 class="text-uppercase text-2xl text-center m-0 p-1"> sản phẩm xem nhiều </h4>
                    </div>
                    <div class="sidebox-content">
                        <div class="item-list d-flex flex-row p-2 gap-1 justify-content-around">
                            <div class="item-img">
                                <img class="w-100" src="https://tourbonphuong.com/upload/product/hinh-chi-tiet-8881.jpg" alt="photo">
                            </div>
                            <div class="img-content py-2 px-3">
                                <h3 class="m-0">
                                    <a href="" class="text-uppercase text-black"> tour miền tây 1 ngày</a>
                                </h3>
                                <div class="img-content-price d-flex flex-row gap-2">
